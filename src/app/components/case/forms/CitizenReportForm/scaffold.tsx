  ...
  const fields = {
    ...
    description_citizenreport: {
      ...
      props: {
        ...
        extraLabel: <InfoButton infoTitle="Korte samenvatting melding" infoText="Geef een korte beschrijving van de melding. Deze informatie komt ook door in TOP voor de toezichthouder." />,
