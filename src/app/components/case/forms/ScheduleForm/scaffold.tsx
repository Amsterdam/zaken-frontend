  ...
  const fields = {
    ...
    priority: {
      ...
      props: {
        ...
        name: 'priority',
        optionLabelField: 'name',
        extraLabel: <InfoButton infoTitle="Urgentie bezoek" infoText="Gebruik hoge urgentie indien er nu toeristen aanwezig zijn, kies machtiging als het bezoek prioriteit krijgt in verband met een machtiging." />,
        isRequired: true,
        withEmptyOption: true,
