  ...
  const fields = {
    violation: {
      ...
      props: {
        ...
        extraLabel: <InfoButton infoTitle="Niet duidelijk of er een overtreding is? Twee opties:" infoText={InfoContent} />,
        name: 'violation',
      ...
      props: {
        ...
        field: {
          ...
          props: {
            ...
            extraLabel: <InfoButton infoTitle="Overlast geconstateerd" infoText="Aanvinken indien overlast geconstateerd is zoals geluid, lawaai, stank en vuil overlast." />,
            options: {
