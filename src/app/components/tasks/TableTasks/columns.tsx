...
export default (sorting: any, myId?: string, isEnforcement?: boolean) => [
  ...
  },
  {
    ...
    sorter: (a: any, b: any) =>
      a?.case?.address?.full_address.localeCompare(
        b?.case?.address?.full_address,
      ),
    sortOrder:
  ...
  },
  {
    ...
    sorter: (a: any, b: any) =>
      a?.case?.address?.postal_code.localeCompare(
        b?.case?.address?.postal_code,
      ),
    sortOrder:
      sorting.dataIndex === "case.address.postal_code" && sorting.order,
  },
  {
    header: "Open taak",
    dataIndex: "name",
  ...
  },
  {
    ...
    sorter: (a: any, b: any) =>
      new Date(a.case.start_date).getTime() -
      new Date(b.case.start_date).getTime(),
  ...
  },
  {
    ...
    render: (due_date: any) => (
      <DueDate date={due_date ?? undefined} emptyText="-" />
    ),
  },
  {
    dataIndex: "case.id",
