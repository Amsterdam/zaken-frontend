...
import {
  Button, Heading, themeColor, themeSpacing,
...
const Details: React.FC<Props> = ({
  isLoading, numLoadingRows, numInitialVisibleRows = Number.MAX_VALUE, title, values, startAlternative = true, headingSize = 'h2',
}) => {
