...
function ConfirmScaffoldForm<T extends Rec, U extends Rec, V extends Rec>(props: Props<T, U, V>) {
  const {
    fields, postMethod, mapData, afterSubmit, initialValues, submittingTitle,
  } = props;
  const {
    isSubmitted,
    data,
