...
import ResidentsOverviewNew from "app/components/addresses/ResidentsOverviewNew/ResidentsOverviewNew"
  ...
  return (
    isValidUrlParamBAGId(bagId) ? (
      <DefaultLayout>
        ...
        <Row>
          <Column spanLarge={ 50 }>
            <ResidentsOverviewNew bagId={ bagId } />
          </Column>
        </Row>
      </DefaultLayout>
    ) : <NotFoundPage />
